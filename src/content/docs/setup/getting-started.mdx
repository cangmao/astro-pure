...
1. Install the theme
   ...
   <TabItem label='bun'>
   ```shell
   bun create astro@latest --template cangmao/astro-pure
   ```
   <Aside type='tip'>
   ...
   <TabItem label='pnpm'>
   ```shell
   pnpm create astro@latest --template cangmao/astro-pure
   ```
   </TabItem>
   <TabItem label='yarn'>
   ```shell
   yarn create astro --template cangmao/astro-pure
   ```
   </TabItem>
   <TabItem label='npm'>
   ```shell
   npm create astro@latest -- --template cangmao/astro-pure
   ```
   </TabItem>
   </Tabs>

   By default, this command will use the template repository’s main branch. To use a different branch name, pass it as part of the `--template` argument: `cangmao/astro-pure#<branch>`.
...
You only need to [click fork button at theme repository](https://github.com/cangmao/astro-pure/fork) to create your project; then clone the forked repository to your local machine.
